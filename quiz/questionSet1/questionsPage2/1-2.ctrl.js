...
vm.currentPage = CheckService.qs1p2; //Reads the points achieved by this particular page from the service, by default is 0.
...
CheckService.qs1p2+= val; //updates the total for the page 1 into the service
vm.currentPage = CheckService.qs1p2; //Updates the current view (text box)
